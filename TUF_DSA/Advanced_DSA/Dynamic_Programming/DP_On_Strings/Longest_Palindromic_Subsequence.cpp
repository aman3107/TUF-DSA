...
int longestPalinSubseqSpace(string s)
{
  int n = s.size();
  string s1 = s;
...
int longestPalinSubseqTabu(string s)
{
  int n = s.size();
  string s1 = s;
  reverse(s.begin(), s.end());
...
int longestPalinSubseqMemo(string s)
{
  int n = s.size();
  string s1 = s;
  reverse(s.begin(), s.end());
  ...
  return helperMemo(n, n, s1, s2, dp);
}
...
int main()
{
  string s1;
  cin >> s1;
  cout << longestPalinSubseqSpace(s1) << endl;
  cout << longestPalinSubseqTabu(s1) << endl;
  cout << longestPalinSubseqMemo(s1) << endl;
  cout << longestPalinSubseq(s1) << endl;
}